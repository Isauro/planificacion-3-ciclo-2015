...
<ul>
<li><a href="#sec-1-1-1">1.1.1. Números y operaciones</a></li>
<li><a href="#sec-1-1-2">1.1.2. Geometría</a></li>
<li><a href="#sec-1-1-3">1.1.3. Medida</a></li>
</ul>
</li>
<li><a href="#sec-1-2">1.2. Cronogramas</a></li>
<li><a href="#sec-1-3">1.3. Secuencias de matemáticas</a>
<ul>
<li><a href="#sec-1-3-1">1.3.1. Primer Cuatrimestre 02/3 - 08/5</a></li>
<li><a href="#sec-1-3-2">1.3.2. Sistema de numeración</a></li>
<li><a href="#sec-1-3-3">1.3.3. Geometría</a></li>
<li><a href="#sec-1-3-4">1.3.4. Khan Academy</a></li>
<li><a href="#sec-1-3-5">1.3.5. Semana 4 y 5</a></li>
<li><a href="#sec-1-3-6">1.3.6. Operaciones 1</a></li>
<li><a href="#sec-1-3-7">1.3.7. Bibliografía - Sitiografía:</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#sec-2">2. Ciencias Naturales</a>
<ul>
<li><a href="#sec-2-1">2.1. Contenidos Ciencias Naturales</a>
<ul>
<li><a href="#sec-2-1-1">2.1.1. Los materiales</a></li>
<li><a href="#sec-2-1-2">2.1.2. Los seres vivos</a></li>
<li><a href="#sec-2-1-3">2.1.3. La Tierra y el universo</a></li>
</ul>
</li>
<li><a href="#sec-2-2">2.2. Cronogramas</a></li>
<li><a href="#sec-2-3">2.3. Secuencias de Ciencias naturales</a>
<ul>
<li><a href="#sec-2-3-1">2.3.1. Los Materiales</a></li>
<li><a href="#sec-2-3-2">2.3.2. Secuencias</a></li>
</ul>
</li>
</ul>
</li>
...
### Números y operaciones<a id="sec-1-1-1"></a>
...
<tr>
<td class="left">02 - 06</td>
<td class="left">Sistema de numeración: Lectura y escritura de números, comparación de cantidades</td>
<td class="left">Repaso de propiedades de figuras: Cuadrado</td>
</tr>


<tr>
<td class="left">09 - 13</td>
<td class="left">Sistema de numeración: Lectura y escritura de números, comparación de cantidades</td>
<td class="left">`~repaso de propiedades de figuras: Cuadrado~`</td>
</tr>
...
<tr>
<td class="left">06 - 10</td>
<td class="left">Problemas y práctica sobre numeración</td>
<td class="left">Suma de ángulos interiores de un triángulo, Estudio del triángulo en relación a la circunferencia</td>
</tr>


<tr>
<td class="left">13 - 17</td>
<td class="left">Problemas multiplicativos con números naturales.</td>
<td class="left">Suma de ángulos interiores de un triángulo, Estudio del triángulo y paralelogramos en relación a la circunferencia</td>
</tr>


<tr>
<td class="left">20 - 24</td>
<td class="left">Resolución de problemas que combinen las cuatro operaciones con números naturales.</td>
<td class="left">Estudio de las propiedades de los paralelogramos a través de la construcción</td>
</tr>


<tr>
<td class="left">27 - 30</td>
<td class="left">Resolución de problemas que combinen las cuatro operaciones con números naturales. <br> evaluación</td>
<td class="left">Estudio de las propiedades de los paralelogramos a través de la construcción</td>
</tr>


<tr>
<td class="left">04 - 08</td>
<td class="left">Resolución de problemas que combinen las cuatro operaciones con números naturales.</td>
<td class="left">Polígonos regulares</td>
</tr>
</tbody>
</table>
...
## Secuencias de matemáticas<a id="sec-1-3"></a>
...
### Primer Cuatrimestre 02/3 - 08/5<a id="sec-1-3-1"></a>
...
### Sistema de numeración<a id="sec-1-3-2"></a>
...
1.  Práctica en vistas de la evaluación
...
1.  Construcciones 1
    ...
    1.  Copien las siguientes figuras respetando las medidas<sup><a id="fnr.3" class="footref" href="#fn.3">3</a></sup>
        1.  ![img](//farm8.staticflickr.com/7435/8723482246_affc3802b8.jpg)
        2.  ![img](//farm8.staticflickr.com/7354/8722362631_dee0690a78.jpg)
    2.  Si tuvieras que enviar un mensaje escrito con instrucciones para hacer las dos figuras que hicieron arriba ¿Qué escribirían?<sup><a id="fnr.4" class="footref" href="#fn.4">4</a></sup>

### Khan Academy<a id="sec-1-3-4"></a>
...
<tr>
<td class="left">25 - 27 <sup><a id="fnr.1.100" class="footref" href="#fn.1">1</a></sup></td>
<td class="left">Sistema de numeración: Descomposición de números en potencias de diez</td>
</tr>


<tr>
<td class="left">30 - 01 <sup><a id="fnr.2.100" class="footref" href="#fn.2">2</a></sup></td>
<td class="left">Sistema de numeración: Descomposición de números en potencias de diez</td>
</tr>
</tbody>
</table>

### Operaciones 1<a id="sec-1-3-6"></a>

1.  Completá estas tablas
...
2.  Matías y Lorena calcularon de maneras diferentes cuántos cuadraditos hay en esta figura
...
3.  En una pared se colocaron 18 filas de 24 cerámicas cada una.
...
### Bibliografía - Sitiografía:<a id="sec-1-3-7"></a>

-   Diseño Curricular de la Ciudad de Buenos Aires
-   Matemática en sexto. Santillana
-   [Khan Academy](http://es.khanacademy.org)

# Ciencias Naturales<a id="sec-2"></a>

## Contenidos Ciencias Naturales<a id="sec-2-1"></a>

### Los materiales<a id="sec-2-1-1"></a>

-   Interacciones entre los materiales.
-   Mezclas y soluciones.
-   El agua.

### Los seres vivos<a id="sec-2-1-2"></a>

-   La diversidad ambiental y la diversidad biológica.
-   Relaciones.
-   Cambios evolutivos.

### La Tierra y el universo<a id="sec-2-1-3"></a>
...
## Secuencias de Ciencias naturales<a id="sec-2-3"></a>

### Los Materiales<a id="sec-2-3-1"></a>
...
### Secuencias<a id="sec-2-3-2"></a>

1.  Conservación de materia en mezclas
...
2.  Modelo de guía de trabajo de laboratorio

3.  Guía de trabajo en el laboratorio
...
4.  Nuestra hipótesis (respuesta) y nuestras predicciones
...
5.  Mi diseño experimental para poner la hipótesis a prueba:
...
<div class="footdef"><sup><a id="fn.3" class="footnum" href="#fnr.3">3</a></sup> La idea de este ejercicio es que los estudiantes utilicen el compás con múltiples propósitos (medir y trazar) y relacionen el radio de la circunferencia para el trazado con el diámetro final de las figuras.</div>

<div class="footdef"><sup><a id="fn.4" class="footnum" href="#fnr.4">4</a></sup> Esta actividad es para comenzar a reflexionar sobre la necesidad de contar con un lenguaje común que abstraiga las propiedades de las figuras para poder reflexionar sobre eso.</div>
